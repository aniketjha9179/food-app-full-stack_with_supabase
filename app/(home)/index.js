...
import HorizontalFlatList from '../../components/Carousel';
  ...
  return (
    <ScrollView style={{ flex: 1, backgroundColor: '#f8f8f8' }}>
      <View style={{ flexDirection: 'row', alignItems: 'center', gap: 12, padding: 12 }}>
        <Octicons name='location' size={25} color={'#E52813'} />
        <View style={{ flex: 1 }}>
          <Text style={{ fontSize: 16, fontWeight: '500' }}>Deliver to</Text>
          <Text style={{ color: 'gray', fontSize: 16, marginTop: 3 }}>{displayCurrentAddress} India </Text>
        </View>
      ...
      {/* image carousel */}
      {/* <Carousel />// not able to implement Carousel */}
      <HorizontalFlatList />
      {/* category */}
      <Categories />
      {/* recommended menu */}
      <ScrollView horizontal showsHorizontalScrollIndicator={false}>
        {
          recommended?.map((item, index) => (
            <View key={index} style={{ backgroundColor: 'white', flexDirection: 'row', margin: 13 }} >
              <View>
                <Image source={{ uri: item?.image }}
                  style={{ width: 100, height: 100, resizeMode: 'cover', borderTopLeftRadius: 8, borderBottomRightRadius: 7 }}
                />
              </View>
              <View style={{ padding: 10, flexDirection: 'column' }}>
                ...
                <View style={{ flexDirection: 'row', alignItems: 'center', gap: 3, }}>
                  <MaterialCommunityIcons name="clock-time-five" size={24} color="green" />
      ...
      <Text style={{textAlign:'center', marginTop:7,letterSpacing:7,marginBottom:5, color:'gray' }}>ALL RESTAURANTS </Text>
